...
source.include_patterns = assets/*,images/*,Model/*,ui/*
...
requirements = python3,kivy==2.3.0,kivymd==1.1.1,sqlite3,numpy,pillow,requests,llama-cpp-python,transformers,scikit-learn,plyer,torch,torchvision
